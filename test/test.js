...
describe('Cross Origin Requests', function(){
    ...
    it('should allow all origins', function() {
        //console.log(assert(result,"header.access-control-allow-origin"));
   ...
   describe('Update Todo Item :',function(){
     ...
     it('should have completed set to true after PUT update',function(){
        ...
        return assert(result, "body.completed").to.equal(true);
     });

     it('should have completed set to false after PATCH update', function(){
       var result = update(location, 'PATCH', {'completed': false});
       return assert(result, "body.completed").to.be.false;
     });
   ...
   describe('Delete Todo Item :',function(){
    ...
    it('should delete the item', function(){
        ...
        return expect(result).to.eventually.be.rejectedWith('Error: Not Found');
    });
...
//Update request and return promise
